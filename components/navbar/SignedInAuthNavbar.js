...
export function SignedInAuthNavbar() {
    ...
    return (<AppBar color="primary" positon="static">
                <Toolbar sx={{pl:0 }}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item md={2} xs={1}><Link variant="h5" color="secondary" underline="none" href="/submittedpapers">Submitted Papers</Link></Grid>
                        <Grid item md={8} xs={1}><Link variant="h5" color="secondary" underline="none" href="/submitpapers">Submit Paper</Link></Grid>
